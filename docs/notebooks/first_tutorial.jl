...
begin
	...
	refs = Dict(
		...
		:crucifix2023 => DOI("10.32614/CRAN.package.palinsol"))
	...
	sort(refs |> values |> collect, by=r->[string(r.year), r.author])
end
...
git-tree-sha1 = "a2c27fa9c6b527f5acc0ab8cfa4a84becdfbf6d1"
...
git-tree-sha1 = "384c62d448522f818e7b745ffd87a33027f7e85b"
