...
H5Writer.run(Model{ALCAP}, INPUT_R, "$(PATH)/$(TAG_R).h5")
...
H5Writer.run(Model{ALCAP}, INPUT_S, "$(PATH)/$(TAG_S).h5")
...
manifest_format = "2.0"
project_hash = "8e7879106c314b990c5851965959cfb2dc19c4f6"
