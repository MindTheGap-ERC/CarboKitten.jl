...
module Script
  ...
  const input = Input(
    ...
    write_interval = 1,
    facies = [
        CaProd.Facies((4, 10), (6, 10), 500.0, 0.8, 300, 1.0, 1.0, 1.0),
        CaProd.Facies((4, 10), (6, 10), 400.0, 0.1, 300, 1.0, 1.0, 1.0),
        CaProd.Facies((4, 10), (6, 10), 100.0, 0.005, 300, 1.0, 1.0, 1.0)
    ],
  ...
  function initial_depth(input::Input)
    box = make_box(input)
  end
