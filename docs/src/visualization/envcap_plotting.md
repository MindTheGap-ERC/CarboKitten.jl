# EnvCAP plotting utilities

This page defines plotting utilities for EnvCAP outputs. These routines are
separate from the main EnvCAP run script. They can be called after the
simulation has completed.

The plotter reconstructs three maps at the same stratigraphic level:

1. the shared environmental belt block,
...
``` {.julia .task file=examples/model/envcap/plot.jl}
#| creates:
#|   - data/output/fig/envcap_ref0_z41_maps.png
#|   - data/output/fig/envcap_ref05_z41_maps.png
#|   - data/output/fig/envcap_ref1_z41_maps.png
#| requires:
